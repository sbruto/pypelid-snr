...
from ipywidgets import Text, Label, HTML, HBox, VBox, Box, Layout, Button, BoundedFloatText, BoundedIntText, Dropdown, Output
...
class Analysis(object):
    ...
    def show_template_table(self, change=None):
        with self.widgets['output']:
            ...
            path = os.path.join(TEMPLATE_DIR, self.widgets['zmeas_template_file'].value)
